  ...
  return (
    <div className='w-full '>
        ...
        <div className=' flex h-[75px] justify-between items-center px-[10px] '>
                <div className=''><Image className='block sm:hidden' src={Burger} alt='DropDown'/></div>
                <div ><Image className='w-[80px] sm:w-[120px] h-[60px] object-cover' src={Logo} alt='Logo'/></div>
                <div><Image src={Cart} alt='Cart'/></div>
        </div>
